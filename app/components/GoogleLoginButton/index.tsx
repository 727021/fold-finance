...
const SocialLoginButton: FC<{}> = () => {
  ...
  const buttonStyles = useMemo<CSSProperties>(() => ({
    ...
    background: hovered || focused ? '#eff0ee' : 'white',
    color: 'black',
    cursor: 'pointer',
    fontSize: '19px',
    margin: '5px',
        ...
        >
          ...
          >
            ...
            <path
              ...
              d="M59,31.97c0.01,7.73-3.26,14.58-8.55,19.31l-7.62-6.72c2.1-1.61,3.77-3.71,4.84-6.15c0.29-0.66-0.2-1.41-0.92-1.41H37c-2.21,0-4-1.79-4-4v-2c0-2.21,1.79-4,4-4h17C56.75,27,59,29.22,59,31.97z"
            />
          </svg>
        </div>
